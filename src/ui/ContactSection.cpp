        ...
        {proto::CONTACTSECTION_COMMUNICATION,
         {
             ...
             {proto::CITEMTYPE_WIRE, 3},
             {proto::CITEMTYPE_QQ, 4},
             {proto::CITEMTYPE_BITMESSAGE, 5},
             {proto::CITEMTYPE_WHATSAPP, 6},
             {proto::CITEMTYPE_TELEGRAM, 7},
             {proto::CITEMTYPE_KIK, 8},
             {proto::CITEMTYPE_BBM, 9},
             {proto::CITEMTYPE_WECHAT, 10},
             {proto::CITEMTYPE_KAKAOTALK, 11},
         }},
        {proto::CONTACTSECTION_PROFILE,
         {
             ...
             {proto::CITEMTYPE_TUMBLR, 4},    {proto::CITEMTYPE_YAHOO, 15},
             {proto::CITEMTYPE_MYSPACE, 5},   {proto::CITEMTYPE_MEETUP, 16},
             {proto::CITEMTYPE_REDDIT, 6},    {proto::CITEMTYPE_HACKERNEWS, 17},
             {proto::CITEMTYPE_WIKIPEDIA, 7}, {proto::CITEMTYPE_ANGELLIST, 18},
             {proto::CITEMTYPE_GITHUB, 8},    {proto::CITEMTYPE_BITBUCKET, 19},
             {proto::CITEMTYPE_YOUTUBE, 9},   {proto::CITEMTYPE_VIMEO, 20},
             {proto::CITEMTYPE_TWITCH, 10},   {proto::CITEMTYPE_SNAPCHAT, 21},
         }},
    };
