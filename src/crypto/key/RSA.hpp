...
#ifndef IMPLEMENTATION_OPENTXS_CRYPTO_KEY_RSA_HPP
#define IMPLEMENTATION_OPENTXS_CRYPTO_KEY_RSA_HPP
...
#endif  // IMPLEMENTATION_OPENTXS_CRYPTO_KEY_RSA_HPP
