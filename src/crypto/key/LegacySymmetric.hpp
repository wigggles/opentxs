...
#ifndef IMPLEMENTATION_OPENTXS_CRYPTO_KEY_LEGACYSYMMETRIC_HPP
#define IMPLEMENTATION_OPENTXS_CRYPTO_KEY_LEGACYSYMMETRIC_HPP
...
#endif  // IMPLEMENTATION_OPENTXS_CRYPTO_KEY_LEGACYSYMMETRIC_HPP
