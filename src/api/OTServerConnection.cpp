...
bool OTServerConnection::ProcessReply(u_header& theCMD,
...
// If this function returns a true, that means theServerReply now contains a
// valid message
