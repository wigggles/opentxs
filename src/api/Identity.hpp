...
#ifndef OPENTXS_CORE_API_IDENTITY_IMPLEMENTATION_HPP
#define OPENTXS_CORE_API_IDENTITY_IMPLEMENTATION_HPP
...
#endif  // OPENTXS_CORE_API_IDENTITY_IMPLEMENTATION_HPP
