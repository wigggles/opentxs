...
constexpr auto OT_ZMQ_REORG_SIGNAL = OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 1};
constexpr auto OT_ZMQ_REGISTER_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 2};
...
constexpr auto OT_ZMQ_DISCONNECT_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 5};
constexpr auto OT_ZMQ_CONNECT_SIGNAL = OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 6};
constexpr auto OT_ZMQ_NEW_FILTER_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 7};
constexpr auto OT_ZMQ_NEW_BLOCK_HEADER_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 8};
constexpr auto OT_ZMQ_NEW_PEER_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 9};
constexpr auto OT_ZMQ_NEW_BLOCKCHAIN_WALLET_KEY_SIGNAL =
    OTZMQWorkType{OT_ZMQ_HIGHEST_SIGNAL - 10};
}  // namespace opentxs
