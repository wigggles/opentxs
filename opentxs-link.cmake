...
if(OT_WITH_QT)
  target_link_libraries(
    ${target_name} PUBLIC ${Qt5Qml_LIBRARIES} ${Qt5Widgets_LIBRARIES}
                   ${Qt5Core_LIBRARIES}
  )
endif()

target_include_directories(${target_name} SYSTEM PRIVATE "${opentxs_SOURCE_DIR}/deps/")
target_include_directories(${target_name} SYSTEM PUBLIC "${Protobuf_INCLUDE_DIRS}")
