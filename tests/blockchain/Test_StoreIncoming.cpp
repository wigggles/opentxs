...
TEST(Test_StoreIncoming, testStoreIncoming)
{
    ...
    // Associate Address at index 0 of Alice's account with an incoming
    // transaction
    ...
    std::shared_ptr<proto::BlockchainTransaction> StoredIncomingTx =
    ...
    // Check assignment: expect address to have an incoming txid matching the
    // Stored tx
