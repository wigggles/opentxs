...
inline utf8_conversion_error::utf8_conversion_error(const char* message,
...
inline utf8_conversion_error::utf8_conversion_error(const std::string& message,
                                                    conversion_type conversion,
                                                    error_code_type error_code)
    : std::runtime_error(message)
    , m_conversion(conversion)
        ...
        throw utf8_conversion_error(
            (error == ERROR_NO_UNICODE_TRANSLATION)
                ...
                : "Can't get length of UTF-16 string (MultiByteToWideChar "
                  "failed).",
            utf8_conversion_error::conversion_utf16_from_utf8, error);
    }
...
inline std::string UTF8FromUTF16(const std::wstring& utf16)
{
    ...
    if (utf8Length == 0) {
        ...
        throw utf8_conversion_error(
            ...
            utf8_conversion_error::conversion_utf8_from_utf16, error);
    }
