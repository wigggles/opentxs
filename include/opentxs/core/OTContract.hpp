...
public:
    ...
    inline void GetName(OTString& strName) const
    {
        strName = m_strName;
    }
    inline void SetName(const OTString& strName)
    {
        m_strName = strName;
    }
    ...
    // If you have a contract in string form, and you don't know what subclass
    // it is,
    // but you still want to instantiate it, and load it up properly, then call
    // this
    // class method.
    //
    ...
    EXPORT bool SaveContractRaw(OTString& strOutput) const; // Saves the raw
                                                            ...
                                                            // any string you
                                                            // want to pass in.
    bool RewriteContract(OTString& strOutput) const; // Takes the pre-existing
