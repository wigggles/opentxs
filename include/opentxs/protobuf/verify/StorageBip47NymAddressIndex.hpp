...
#ifndef OPENTXS_PROTOBUF_STORAGE_BIP47_NYM_ADDRESS_INDEX_HPP
#define OPENTXS_PROTOBUF_STORAGE_BIP47_NYM_ADDRESS_INDEX_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const StorageBip47NymAddressIndex& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_STORAGE_BIP47_NYM_ADDRESS_INDEX_HPP
