...
#ifndef OPENTXS_PROTOBUF_STORAGE_WORKFLOW_INDEX_HPP
#define OPENTXS_PROTOBUF_STORAGE_WORKFLOW_INDEX_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const StorageWorkflowIndex& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_STORAGE_WORKFLOW_INDEX_HPP
