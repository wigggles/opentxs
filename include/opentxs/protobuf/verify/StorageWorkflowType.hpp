...
#ifndef OPENTXS_PROTOBUF_STORAGE_WORKFLOW_TYPE_HPP
#define OPENTXS_PROTOBUF_STORAGE_WORKFLOW_TYPE_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const StorageWorkflowType& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_STORAGE_WORKFLOW_TYPE_HPP
