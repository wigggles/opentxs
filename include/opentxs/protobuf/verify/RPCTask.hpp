...
#ifndef OPENTXS_PROTOBUF_RPCTASK_HPP
#define OPENTXS_PROTOBUF_RPCTASK_HPP
...
namespace proto
{
OPENTXS_EXPORT bool CheckProto_1(const RPCTask& input, const bool silent);
OPENTXS_EXPORT bool CheckProto_2(const RPCTask& input, const bool silent);
OPENTXS_EXPORT bool CheckProto_3(const RPCTask& input, const bool silent);
OPENTXS_EXPORT bool CheckProto_4(const RPCTask& input, const bool silent);
OPENTXS_EXPORT bool CheckProto_5(const RPCTask& input, const bool silent);
OPENTXS_EXPORT bool CheckProto_6(const RPCTask& input, const bool silent);
...
#endif  // OPENTXS_PROTOBUF_RPCTASK_HPP
