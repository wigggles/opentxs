...
#ifndef OPENTXS_PROTOBUF_INSTRUMENTREVISION_HPP
#define OPENTXS_PROTOBUF_INSTRUMENTREVISION_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const InstrumentRevision& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_INSTRUMENTREVISION_HPP
