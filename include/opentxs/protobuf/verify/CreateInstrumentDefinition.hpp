...
#ifndef OPENTXS_PROTOBUF_CREATEINSTRUMENTDEFINITION_HPP
#define OPENTXS_PROTOBUF_CREATEINSTRUMENTDEFINITION_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const CreateInstrumentDefinition& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_CREATEINSTRUMENTDEFINITION_HPP
