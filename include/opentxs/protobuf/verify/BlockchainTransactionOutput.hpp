...
#ifndef OPENTXS_PROTOBUF_BLOCKCHAIN_TRANSACTION_OUTPUT_HPP
#define OPENTXS_PROTOBUF_BLOCKCHAIN_TRANSACTION_OUTPUT_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const BlockchainTransactionOutput& output,
    const bool silent);
OPENTXS_EXPORT bool CheckProto_2(
    const BlockchainTransactionOutput&,
    const bool);
...
#endif  // OPENTXS_PROTOBUF_BLOCKCHAIN_TRANSACTION_OUTPUT_HPP
