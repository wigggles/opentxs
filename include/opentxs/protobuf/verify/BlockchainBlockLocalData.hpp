...
#ifndef OPENTXS_PROTOBUF_BLOCKCHAIN_BLOCK_LOCAL_DATA_HPP
#define OPENTXS_PROTOBUF_BLOCKCHAIN_BLOCK_LOCAL_DATA_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const BlockchainBlockLocalData& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_BLOCKCHAIN_BLOCK_LOCAL_DATA_HPP
