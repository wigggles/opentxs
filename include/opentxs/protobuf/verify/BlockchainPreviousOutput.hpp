...
#ifndef OPENTXS_PROTOBUF_BLOCKCHAIN_PREVIOUS_OUTPUT_HPP
#define OPENTXS_PROTOBUF_BLOCKCHAIN_PREVIOUS_OUTPUT_HPP
...
OPENTXS_EXPORT bool CheckProto_1(
    const BlockchainPreviousOutput& input,
    const bool silent);
...
#endif  // OPENTXS_PROTOBUF_BLOCKCHAIN_PREVIOUS_OUTPUT_HPP
